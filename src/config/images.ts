...
export const IMAGE_MANIFEST: readonly ImageSpec[] = [
	...
	{
		file: 'room-garden.jpg',
		width: 1600,
		height: 1200,
		placeholderColour: '#6FB3B0',
		brief: 'The garden room, shot from the doorway with the bed and the window in frame.',
		usedOn: 'Homepage, rooms section',
	},
	{
		file: 'room-sea-view.jpg',
		width: 1600,
		height: 1200,
		placeholderColour: '#4E8F94',
		brief: 'The sea view room, ideally showing what you actually see out of the window.',
		usedOn: 'Homepage, rooms section',
	},
	{
		file: 'room-family.jpg',
		width: 1600,
		height: 1200,
		placeholderColour: '#2E6E7E',
		brief: 'The family room, wide enough to show all the beds.',
		usedOn: 'Homepage, rooms section',
	},
	{
